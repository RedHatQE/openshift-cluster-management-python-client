...
from ocm_cluster_management_client import rest
from ocm_cluster_management_client.configuration import Configuration
from ocm_cluster_management_client.exceptions import ApiTypeError, ApiValueError, ApiException
from ocm_cluster_management_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.api_clusters_mgmt_v1_addons_addon_id_delete  # this is an instance of the class Endpoint
        api_instance.api_clusters_mgmt_v1_addons_addon_id_delete()  # this invokes api_instance.api_clusters_mgmt_v1_addons_addon_id_delete.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.api_clusters_mgmt_v1_addons_addon_id_delete.callable or self.callable in this class
